    ...
    var body: some View {
            ZStack {
                ...
                VStack {
                    ...
                    CustomTextField(placeholder: "Staff ID", text: $id, isSecure: false)
                    ...
                    CustomTextField(placeholder: "Postion", text: $position, isSecure: false)
                    CustomTextField(placeholder: "Faculty", text: $faculty, isSecure: false)
                    HStack {
                    ...
                    Button{
                        Task {
                            try await viewModel.createUser(withEmail: email, password: password, fullname: fullname, userType: .staff, studentID: nil, year: nil, course: nil, staffID: Int(id), position: position, faculty: faculty)
                        }
                    } label: {
                        HStack {
                            Text("Register")
