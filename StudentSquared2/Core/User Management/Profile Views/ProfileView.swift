...
struct ProfileView: View {
    ...
    var body: some View {
                    ZStack() {
                        ...
                        if let student = viewModel.currentStudent, student.userType == .student {
                            StudentProfileDetails(student: student)
                        } else if let staff = viewModel.currentStaff, staff.userType == .staff, staff.position == "Lecturer" {
                            LecturerProfileDetails(staff: staff)
                        } else if let staff = viewModel.currentStaff, staff.userType == .staff, staff.position == "Admin" {
                            AdminProfileDetails(staff: staff)
                        } else if let staff = viewModel.currentStaff, staff.userType == .staff, staff.position == "Staff" {
                            StaffProfileDetails(staff: staff)
                        } else {
                            Text("Not Signed In")
...
struct StudentProfileDetails: View {
    @EnvironmentObject var viewModel: AuthViewModel
    let student: Student
...
struct LecturerProfileDetails: View {
    @EnvironmentObject var viewModel: AuthViewModel
    let staff: Staff
    ...
    var body: some View {
            ZStack() {
                ...
                ZStack() {
                    ...
                    Rectangle() //account details rectangle
                        .foregroundColor(.clear)
                        .frame(width: 339, height: 182)
                        .background(.white)
                        .cornerRadius(26)
                        .offset(x: 0.04, y: -18)
                    
                    //Text("FCI")
                    Text(staff.faculty) //faculty
                        .font(Font.custom("Outfit", size: 14).weight(.semibold))
                        .foregroundColor(Color(red: 0.46, green: 0.36, blue: 0.73))
                        .frame(width: 310, alignment: .trailing)
                        .offset(y: 52)
                    //Text("Lecturer")
                    Text(staff.position) //position
                        .font(Font.custom("Outfit", size: 14).weight(.semibold))
                        .foregroundColor(Color(red: 0.46, green: 0.36, blue: 0.73))
                        .frame(width: 310, alignment: .trailing)
                        .offset(y: 15)
                    //Text("Imran@gmail.com")
                    Text(staff.email) //email
                        ...
                        .offset(y: -21)
                    //Text("Imran Bard")
                    Text(staff.fullname) //fullname
                        .font(Font.custom("Outfit", size: 14).weight(.semibold))
                        .foregroundColor(Color(red: 0.46, green: 0.36, blue: 0.73))
                        .frame(width: 310, alignment: .trailing)
                        .offset(y: -56)
                    //Text("3")
                    Text("\(staff.staffID)") //studentID
                        .font(Font.custom("Outfit", size: 14).weight(.semibold))
                        .foregroundColor(Color(red: 0.46, green: 0.36, blue: 0.73))
                        .frame(width: 310, alignment: .trailing)
                        .offset(y: -92)
...
struct AdminProfileDetails: View {
    @EnvironmentObject var viewModel: AuthViewModel
    let staff: Staff
...
struct StaffProfileDetails: View {
    @EnvironmentObject var viewModel: AuthViewModel
    let staff: Staff
