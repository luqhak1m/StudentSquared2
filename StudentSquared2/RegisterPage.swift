...
struct RegisterPage: View {
    ...
    @State private var firstCustomField = ""
    @State private var secondCustomField = ""
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                CustomTextField(placeholder: "Email address/User ID", text: $id, isSecure: false)
                ...
                CustomTextField(placeholder: "Name", text: $name, isSecure: false)
                CustomTextField(placeholder: "Email Address", text: $email, isSecure: false)
                CustomTextField(placeholder: firstPlaceholder, text: $firstCustomField, isSecure: false)
                CustomTextField(placeholder: secondPlaceholder, text: $secondCustomField, isSecure: false)
...
struct RegisterPage_Previews: PreviewProvider {
    static var previews: some View {
        RegisterPage(firstPlaceholder: "Option 1", secondPlaceholder: "Option 2", title: "Test \nRegistration", actionTitle: "Register") {
